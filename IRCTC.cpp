...
void database()
{
    ...
    if (strcmp(pass, password) == 0)
    {
        ...
        do
        {
            ...
            cout << "\t\t\t\t\t\t\t3. Diplay Passenger details \n";
                ...
                while (f1.read((char *)&a, sizeof(a)))
                {
                    if (a.tno == c.tno)
                    {
                        ...
                        if ((c.d == d) && (c.m == m))
                        {
                            ...
                            c.amr = tamt - ((tamt * 40) / 100); // 60% amount is Refunded
                        }
                        else if (c.m == m)
                        {
                            cout << "\t\t\t\t\t\t\t\tYou are cancelling at the month of departure\n";
                            c.amr = tamt - ((tamt * 30) / 100); // 70% amount is Refunded
                        }
                        else if (m > c.m)
                        {
                            cout << "\t\t\t\t\t\t\t\tYou are cancelling one month before the date of departure\n";
                            c.amr = tamt - ((tamt * 20) / 100); // 80% amount is Refunded
                        }
                        else
                        {
